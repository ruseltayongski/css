 ...
 * Page format.
 */
define ('PDF_PAGE_FORMAT', 'GOVERNMENTLEGAL');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Department of Health');
...
define ('PDF_HEADER_STRING', "Client Satisfaction Survey\n$currentDate");
 ...
 * Left margin.
 */
if(isset($_SESSION['consolidated'])){
	define ('PDF_MARGIN_LEFT', 8);
}
elseif(isset($_SESSION['archieved']))
