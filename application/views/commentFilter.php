			...
			<div class="row vertical-center-row">
				<div align="center">
					...
					<?php } ?>
						...
						<form method="GET" target="_blank" action="<?php echo base_url('css/comment_suggestion'); ?>">
							<div class="form-group">
								...
								<button type="submit" class="btn btn-primary" style="margin-top:20px;margin-bottom:20px;" name="generate">Generate Comment/Suggestion (PDF)</button>
							</div>
						</form>
					</div>
				</div>
