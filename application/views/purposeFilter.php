			...
			<div class="row vertical-center-row">
				<div align="center">
					...
					<?php } ?>
						...
						<form method="GET" target="_blank" action="<?php echo base_url('css/purpose_others'); ?>">
							<div class="form-group">
								...
								<button type="submit" class="btn btn-primary" style="margin-top:20px;margin-bottom:20px;" name="generate">Generate Purpose/Others (PDF)</button>
							</div>
						</form>
					</div>
				</div>
