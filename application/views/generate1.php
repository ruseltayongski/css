...
<!DOCTYPE HTML>
	...
	<body>
		...
		<form action="" method="POST" name="form" id="form">
			...
			<table>
				<b>Report Noted By: </b><select id="field" name="apprname" style = "border-radius:5px; width:200px;background-color:lightgreen" required>
			...
			<tr><td><br>
				...
				<button id = "genpdf" type="submit" name = "generate" style="display:inline;">Generate</button></td></tr>
			</table>
		</center>
		</form>
		</div>
