					...
					<?php } ?>
						...
						<form method="POST">
							<div class="form-group">
								<?php 
								if(isset($_SESSION['superuser'])) {
									echo "<select name='section' class='form-control' style='width:50%;margin-top:20px;' required>";
										echo "<option value=''>"."Select Section"."</option>";
										foreach($_SESSION['sections'] as $row){
								?>
								...
								<button type="submit" class="btn btn-primary" style="margin-top:20px;margin-bottom:20px;" name="consolidate">Generate Archieved Per Section(PDF)</button>
							</div>
						</form>
					</div>
				</div>
