					...
					<?php } ?> 
						...
						<form method="POST">
							<div class="form-group">
								...
								<button type="submit" class="btn btn-info" style="margin-top:20px;margin-bottom:10px;background:blue;" name="generateDays" onclick="daysRequired();" >Generate Report By Days In Region</button>
								<button type="submit" class="btn btn-primary" style="margin-top:20px;margin-bottom:10px;background:green;" name="generateMonth" onclick="monthRequired();" >Generate Report By Month In Region</button><hr>
							</div>
						</form>
					</div>
				</div>
