		...
		<div class="container container-table">
			<div class="row vertical-center-row">
				<div align="center">
					...
					<div style="position:absolute;"><button type="button" class="btn btn-warning" style="color:black;" onclick="location.href='user'"><p class="glyphicon glyphicon-arrow-left">BACK</p></button></div>
					<?php } else{ ?>
					<div style="position:absolute;"><button type="button" class="btn btn-warning" style="color:black;" onclick="location.href='admin'"><p class="glyphicon glyphicon-arrow-left">BACK</p></button></div>
					<?php } ?>
						...
						<form method="POST">
							<div class="form-group">
								...
								<button type="submit" class="btn btn-warning" style="margin-top:20px;margin-bottom:20px;color:black;" name="generate">Generate Archieved Per Region(PDF)</button>
							</div>
						</form>
					</div>
				</div>
