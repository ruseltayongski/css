			...
			<div class="row vertical-center-row">
				<div align="center">
					...
					<?php } ?>
						...
						<form method="GET" target="_blank" action="<?php echo base_url('css/staff_rendered'); ?>">
							<div class="form-group">
								...
								<button type="submit" class="btn btn-primary" style="margin-top:20px;margin-bottom:20px;" name="generate">Download Staff Who Rendered (Excel)</button>
							</div>
						</form>
					</div>
				</div>
